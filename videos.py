...
adm.addVideoFilter("swscale", "width=640", "height=480", "algo=2", "sourceAR=0", "targetAR=0", "lockAR=True", "roundup=False")
adm.addVideoFilter("addLogo", "x=490", "y=430", "alpha=255", "logoImageFile=E:/batch/rgbpi_logocolores.png", "fade=500")
adm.addVideoFilter("addLogo", "x=495", "y=445", "alpha=255", "logoImageFile=E:/batch/packlogo.png", "fade=500")
